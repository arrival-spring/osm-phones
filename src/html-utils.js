        ...
        <div class="max-w-4xl mx-auto space-y-8">
            <header class="text-center relative"> 
                <div class="absolute top-0 right-0 flex items-center space-x-2">
                    ${themeButton}
                    <button id="settings-toggle" class="hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors" aria-label="${translate('settings', locale)}">
